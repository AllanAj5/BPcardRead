...
public class str_Similarity_Check {
//
//    public static void main(String args[]) {
//        printSimilarity("", "");
//        printSimilarity("Government of India", "Govemment of India");
//
//    }
    public static double printSimilarity(String s, String t)
    {
        Double x = similarity(s, t);
        return x;
    }
    /**
     * JaroWinklerDistance
     * Reference https://commons.apache.org/sandbox/commons-text/jacoco/org.apache.commons.text.similarity/JaroWinklerDistance.java.html
     */
